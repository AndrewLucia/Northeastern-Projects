...
public class OvalTest {
  ...
  public void testNullName() {
    ...
    new Oval(null, 20, 80, 4, 6, 0, 5, color);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNegDimX() {
    Color color = new ColorRGB(0, 0, 0);
    new Oval("O", 20, 80, -4, 6, 0, 5, color);
  }
  ...
  public void testNegAppear() {
    Color color = new ColorRGB(0, 0, 0);
    new Oval("O", 20, 80, 4, 6, -5, 10, color);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNegDisappear() {
    Color color = new ColorRGB(0, 0, 0);
    new Oval("O", 20, 80, 4, 6, 0, -10, color);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testNegTime() {
    Color color = new ColorRGB(0, 0, 0);
    new Oval("O", 20, 80, 4, 6, -15, -10, color);
  }
  ...
  public void testGetName() {
    Color color = new ColorRGB(0, 0, 0);
    Shape2D shape = new Oval("O", 20, 80, 4, 6, 10, 15, color);
    assertEquals("O", shape.getName());
  }
  ...
  public void testToText() {
    Color color = new ColorRGB(0, 0, 0);
    Shape2D shape = new Oval("O", 20, 80, 4, 6, 10, 15, color);
    assertEquals("Name: O" + System.lineSeparator()
        + "Type: oval" + System.lineSeparator()
        + "Center: (20.0,80.0), X radius: 4.0, Y radius: 6.0, Color: (0.0,0.0,0.0)" + System
        .lineSeparator()
  ...
  public void testDimensionAsText() {
    Color color = new ColorRGB(0, 0, 0);
    Shape2D shape = new Oval("O", 20, 80, 4, 6, 10, 15, color);
    assertEquals("X radius: 4.0, Y radius: 6.0", shape.dimensionsAsText(4.0, 6.0));
  }
  ...
  public void testAddAnimation() {
    ...
    Animation a1 = new AnimationMove(shape, 0, 0, 5.0, 10, 10, 14);
    shape.addAnimation(a1);
    l1.add(a1);
    assertEquals(l1, shape.getAnimations());

    Animation a2 = new AnimationScale(shape, 0, 0, 5.0, 10, 10, 14);
